...
public class DM24SPNSupportPacketTest {
    ...
    public void testActual() {
        ...
        expected += "  a r e F" + NL;
        expected += "  t F s l" + NL;
        expected += "  a r t n  SPN — SP Name" + NL;
        expected += "  ----------------------" + NL;
        ...
        expected += "  D     1  SPN 3069 - Distance Travelled While MIL is Activated" + NL;
        ...
        expected += "  D     1  SPN 3294 - Distance Since Diagnostic Trouble Codes Cleared" + NL;
        ...
        expected += "  D     1  SPN 3302 - Number of Warm-Ups Since Diagnostic Trouble Codes Cleared" + NL;
        expected += "  D     1  SPN 3303 - Continuously Monitored Systems Enabled/Completed Status" + NL;
        expected += "  D     1  SPN 3304 - Non-Continuously Monitored Systems Enabled Status" + NL;
