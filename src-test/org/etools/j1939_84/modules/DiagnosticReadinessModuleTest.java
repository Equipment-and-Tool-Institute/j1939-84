...
public class DiagnosticReadinessModuleTest {
    ...
    public void testGetDM20PacketsFalse() throws BusException {
        ...
        expected += "10:15:30.0000 18C2A500 11 22 33 44 55 66 77 88" + NL;
        expected += "10:15:30.0000 18C2A517 01 02 03 04 05 06 07 08" + NL;
        expected += "10:15:30.0000 18C2A521 10 20 30 40 50 60 70 80" + NL;
    ...
    public void testGetDM20PacketsWithEngine1Response() throws BusException {
        ...
        expected += "10:15:30.0000 Global DM20 Request" + NL;
        expected += "10:15:30.0000 18EAFFA5 00 C2 00 (TX)" + NL;
        expected += "10:15:30.0000 18C2A501 11 22 33 44 55 66 77 88" + NL;
    ...
    public void testReportDM21() throws BusException {
        ...
        DM21DiagnosticReadinessPacket packet2 = new DM21DiagnosticReadinessPacket(
                Packet.create(pgn | BUS_ADDR, 0x17, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x77, 0x88));
        DM21DiagnosticReadinessPacket packet3 = new DM21DiagnosticReadinessPacket(
                Packet.create(pgn | BUS_ADDR, 0x21, 0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x77, 0x88));
        doReturn(Stream.of(packet1.getPacket(), packet2.getPacket(), packet3.getPacket())).when(j1939).read(anyLong(),
                any());
        ...
        expected += "10:15:30.0000 18C1A500 11 22 33 44 55 66 77 88" + NL;
        ...
        expected += "]" + NL;
        expected += "10:15:30.0000 18C1A517 01 02 03 04 05 06 77 88" + NL;
        ...
        expected += "  Time Since DTCs Cleared:                      34,935 minutes" + NL;
        expected += "]" + NL;
        expected += "10:15:30.0000 18C1A521 10 20 30 40 50 60 77 88" + NL;
        expected += "DM21 from Body Controller (33): [" + NL;
        expected += "  Distance Traveled While MIL is Activated:     8,208 km (5,100.215 mi)" + NL;
        expected += "  Time Run by Engine While MIL is Activated:    24,656 minutes" + NL;
        expected += "  Distance Since DTCs Cleared:                  16,432 km (10,210.371 mi)" + NL;
