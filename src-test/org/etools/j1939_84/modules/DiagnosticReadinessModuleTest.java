...
public class DiagnosticReadinessModuleTest {
    ...
    public void testGetDM26PacketsFalse() throws BusException {
        ...
        expected += "10:15:30.0000 18FDB800 [8] 11 22 33 44 55 66 77 88" + NL;
        expected += "10:15:30.0000 18FDB817 [8] 01 02 03 04 05 06 07 08" + NL;
        expected += "10:15:30.0000 18FDB821 [8] 10 20 30 40 50 60 70 80" + NL;
    ...
    public void testGetDM26PacketsWithEngine1Response() throws BusException {
        ...
        expected += "10:15:30.0000 Global DM26 Request" + NL;
        expected += "10:15:30.0000 18EAFFA5 [3] B8 FD 00 (TX)" + NL;
        expected += "10:15:30.0000 18FDB801 [8] 11 22 33 44 55 66 77 88" + NL;
    ...
    public void testGetDM5PacketsEngine1Response() throws BusException {
        ...
        expected += "10:15:30.0000 18FECE01 [8] 11 22 33 44 55 66 77 88" + NL;
    ...
    public void testReportDM20() throws BusException {
        ...
        assertTrue(instance.reportDM20(listener));
        assertEquals(expected, listener.getResults());
