...
public class SectionA5VerifierTest extends AbstractControllerTest {
    ...
    public void testVerifyDataNotPartialErasedHappyPathNoFailuresAllNotErased() {
        ...
        when(verifier.checkDM6(listener, null, 0, false)).thenReturn(true);
        when(verifier.checkDM12(listener, null, 0, false)).thenReturn(true);
        when(verifier.checkDM23(listener, null, 0, false)).thenReturn(true);
        when(verifier.checkDM29(listener, null, 0, false)).thenReturn(true);
        when(verifier.checkDM5(listener, null, 0, false)).thenReturn(true);
        when(verifier.checkDM25(listener, null, 0, false)).thenReturn(true);
        when(verifier.checkDM31(listener, null, 0, false)).thenReturn(true);
        when(verifier.checkDM21(listener, null, 0, false)).thenReturn(true);
        when(verifier.checkDM26(listener, null, 0, false)).thenReturn(true);
        when(verifier.checkTestResults(listener, null, 0, false)).thenReturn(true);
        when(verifier.checkDM20(listener, null, 0)).thenReturn(true);
        when(verifier.checkDM28(listener, null, 0)).thenReturn(true);
        when(verifier.checkDM33(listener, null, 0)).thenReturn(true);
        when(verifier.checkEngineRunTime(listener, null, 0)).thenReturn(true);
        when(verifier.checkEngineIdleTime(listener, null, 0)).thenReturn(true);

        when(verifier.checkDM6(listener, null, 1, false)).thenReturn(true);
        when(verifier.checkDM12(listener, null, 1, false)).thenReturn(true);
        when(verifier.checkDM23(listener, null, 1, false)).thenReturn(true);
        when(verifier.checkDM29(listener, null, 1, false)).thenReturn(true);
        when(verifier.checkDM5(listener, null, 1, false)).thenReturn(true);
        when(verifier.checkDM25(listener, null, 1, false)).thenReturn(true);
        when(verifier.checkDM31(listener, null, 1, false)).thenReturn(true);
        when(verifier.checkDM21(listener, null, 1, false)).thenReturn(true);
        when(verifier.checkDM26(listener, null, 1, false)).thenReturn(true);
        when(verifier.checkTestResults(listener, null, 1, false)).thenReturn(true);
        when(verifier.checkDM20(listener, null, 1)).thenReturn(true);
        when(verifier.checkDM28(listener, null, 1)).thenReturn(true);
        when(verifier.checkDM33(listener, null, 1)).thenReturn(true);
        when(verifier.checkEngineRunTime(listener, null, 1)).thenReturn(true);
        when(verifier.checkEngineIdleTime(listener, null, 1)).thenReturn(true);

        instance.verifyDataNotPartialErased(listener, SECTION, "Section2", false);

        verify(verifier).checkDM6(listener, null, 0, false);
        verify(verifier).checkDM12(listener, null, 0, false);
        verify(verifier).checkDM23(listener, null, 0, false);
        verify(verifier).checkDM29(listener, null, 0, false);
        verify(verifier).checkDM5(listener, null, 0, false);
        verify(verifier).checkDM25(listener, null, 0, false);
        verify(verifier).checkDM31(listener, null, 0, false);
        verify(verifier).checkDM21(listener, null, 0, false);
        verify(verifier).checkDM26(listener, null, 0, false);
        verify(verifier).checkTestResults(listener, null, 0, false);
        verify(verifier).checkDM20(listener, null, 0);
        verify(verifier).checkDM28(listener, null, 0);
        verify(verifier).checkDM33(listener, null, 0);
        verify(verifier).checkEngineRunTime(listener, null, 0);
        verify(verifier).checkEngineIdleTime(listener, null, 0);

        verify(verifier).checkDM6(listener, null, 1, false);
        verify(verifier).checkDM12(listener, null, 1, false);
        verify(verifier).checkDM23(listener, null, 1, false);
        verify(verifier).checkDM29(listener, null, 1, false);
        verify(verifier).checkDM5(listener, null, 1, false);
        verify(verifier).checkDM25(listener, null, 1, false);
        verify(verifier).checkDM31(listener, null, 1, false);
        verify(verifier).checkDM21(listener, null, 1, false);
        verify(verifier).checkDM26(listener, null, 1, false);
        verify(verifier).checkTestResults(listener, null, 1, false);
        verify(verifier).checkDM20(listener, null, 1);
        verify(verifier).checkDM28(listener, null, 1);
        verify(verifier).checkDM33(listener, null, 1);
        verify(verifier).checkEngineRunTime(listener, null, 1);
        verify(verifier).checkEngineIdleTime(listener, null, 1);
    ...
    public void testVerifyDataNotPartialErasedHappyPathNoFailuresAllErased() {
        ...
        when(verifier.checkDM6(listener, null, 0, false)).thenReturn(false);
        when(verifier.checkDM12(listener, null, 0, false)).thenReturn(false);
        when(verifier.checkDM23(listener, null, 0, false)).thenReturn(false);
        when(verifier.checkDM29(listener, null, 0, false)).thenReturn(false);
        when(verifier.checkDM5(listener, null, 0, false)).thenReturn(false);
        when(verifier.checkDM25(listener, null, 0, false)).thenReturn(false);
        when(verifier.checkDM31(listener, null, 0, false)).thenReturn(false);
        when(verifier.checkDM21(listener, null, 0, false)).thenReturn(false);
        when(verifier.checkDM26(listener, null, 0, false)).thenReturn(false);
        when(verifier.checkTestResults(listener, null, 0, false)).thenReturn(false);
        when(verifier.checkDM20(listener, null, 0)).thenReturn(false);
        when(verifier.checkDM28(listener, null, 0)).thenReturn(false);
        when(verifier.checkDM33(listener, null, 0)).thenReturn(false);
        when(verifier.checkEngineRunTime(listener, null, 0)).thenReturn(false);
        when(verifier.checkEngineIdleTime(listener, null, 0)).thenReturn(false);

        when(verifier.checkDM6(listener, null, 1, false)).thenReturn(false);
        when(verifier.checkDM12(listener, null, 1, false)).thenReturn(false);
        when(verifier.checkDM23(listener, null, 1, false)).thenReturn(false);
        when(verifier.checkDM29(listener, null, 1, false)).thenReturn(false);
        when(verifier.checkDM5(listener, null, 1, false)).thenReturn(false);
        when(verifier.checkDM25(listener, null, 1, false)).thenReturn(false);
        when(verifier.checkDM31(listener, null, 1, false)).thenReturn(false);
        when(verifier.checkDM21(listener, null, 1, false)).thenReturn(false);
        when(verifier.checkDM26(listener, null, 1, false)).thenReturn(false);
        when(verifier.checkTestResults(listener, null, 1, false)).thenReturn(false);
        when(verifier.checkDM20(listener, null, 1)).thenReturn(false);
        when(verifier.checkDM28(listener, null, 1)).thenReturn(false);
        when(verifier.checkDM33(listener, null, 1)).thenReturn(false);
        when(verifier.checkEngineRunTime(listener, null, 1)).thenReturn(false);
        when(verifier.checkEngineIdleTime(listener, null, 1)).thenReturn(false);
