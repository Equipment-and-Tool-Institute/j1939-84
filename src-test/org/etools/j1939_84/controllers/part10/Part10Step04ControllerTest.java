...
public class Part10Step04ControllerTest extends AbstractControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        instance = new Part10Step04Controller(executor,
                                              bannerModule,
    ...
    public void testFailureForNoDTC() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.10.4.2.a - No ECU reported a permanent DTC");
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.10.4.2.c - OBD module Engine #1 (0) did not provide a NACK for the DS query");
    }
    ...
    public void testFailureForNoNACK() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.10.4.2.c - OBD module Engine #2 (1) did not provide a NACK for the DS query");
    }
