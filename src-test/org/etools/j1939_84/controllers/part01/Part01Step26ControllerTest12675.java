...
public class Part01Step26ControllerTest12675 extends AbstractControllerTest {
    ...
    public void testRunObdPgnSupports12675FailureEightB() throws BusException {
        ...
        verify(mockListener).addOutcome(eq(instance.getPartNumber()),
                                        ...
                                        eq(FAIL),
                                        eq("6.1.26.8.b - Bin value received is greater than 0xFAFFFFFF(h) and less than 0xFFFFFFFFh from Engine #1 (0) for SPN 12679, NOx Tracking Engine Activity Lifetime Fuel Consumption Bin 5: Not Available [0xFB, 0xFF, 0xFF, 0xFF]"));
        ...
        expected+= "| Bin  5 (<25%, 40-64kph)   |            0 |Not Available |            0 |            0 |" + NL;
    ...
    public void testRunObdPgnSupports12675FailureTenD() {
        ...
        verify(mockListener).addOutcome(eq(1), eq(26), eq(FAIL), eq("6.1.26.10.d - Active 100 hr array value received is greater than zero (where supported) from Engine #1 (0) for SPN 12348, NOx Tracking Active 100 Hour Engine Out NOx Mass Bin 11: 511705.088 g"));
    ...
    public void testRunObdPgnSupports12675FailureTenA() {
        ...
        verify(mockListener).addOutcome(eq(1),
                                        eq(26),
                                        eq(FAIL),
                                        eq("6.1.26.10.a - No response was received from Engine #1 (0)"));
    ...
    public void testRunObdPgnSupports12675WarningTenB() {
        ...
        verify(mockListener).addOutcome(eq(1),
                                        eq(26),
                                        eq(WARN),
                                        eq("6.1.26.10.b - No response was received from Engine #1 (0)"));
    ...
    @Test
    public void testRunObdPgnSupports12675Failure8A() {
        int supportedSpn = 12675;
        List<Integer> supportedSpns = List.of(supportedSpn);
        ...
        verify(mockListener).addOutcome(eq(1),
                                        eq(26),
                                        eq(FAIL),
                                        eq("6.1.26.8.a - No response was received from Engine #1 (0)"));
