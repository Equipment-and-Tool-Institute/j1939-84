...
public class Part01Step26ControllerSPN12783Test extends AbstractControllerTest {
    ...
    public void testRunObdPgnSupports12783FailureTwentyfourB() {
        ...
        verify(mockListener).addOutcome(eq(1), eq(26), eq(FAIL), eq("6.1.26.24.a - No response was received from Engine #1 (0)"));
