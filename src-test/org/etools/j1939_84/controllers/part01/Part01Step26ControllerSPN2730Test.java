...
public class Part01Step26ControllerSPN2730Test extends AbstractControllerTest {
...
//        verify(broadcastValidator).buildPGNPacketsMap(List.of(packet2));
    ...
    public void testRunObdPgnSupports12730() throws BusException {
        Arrays.asList(12730, 222, 333, 444, 555, 666, 777, 888, 999);
        spns(12730, 222, 333, 444, 555, 666, 777, 888, 999);
        ...
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += "| Engine Run Time, min    |           0 |       4,500 |  23,112,963 |" + NL;
        ...
        expected += "| Urban Speed Run Time,min|           0 |       1,688 |   1,966,080 |" + NL;
        expected += "| Idle Run Time, min      |           0 |         112 |           0 |" + NL;
        expected += "| Engine Idle Fuel, l     |           0 |           6 |           0 |" + NL;
        expected += "| PTO Run Time, min       |           0 |       1,125 |           0 |" + NL;
        expected += "| PTO Fuel Consumption, l |           0 |          59 |           0 |" + NL;
        expected += "| AES Shutdown Count      |           0 |           5 |           0 |" + NL;
        expected += "| Stop-Start Run Time, min|           0 |         225 |           0 |" + NL;
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += NL;
