...
public class Part11Step13ControllerTest12691 extends AbstractControllerTest {
    ...
    public void testRunObdPgnSupports12691ActiveFailureThirteenTwelveDAndE() {
        ...
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 4.000 km (index 6)"));
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 256.000 km (index 192)"));

        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 14336.000 km (index 73)"));
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 8638.250 km (index 121)"));
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 13482.000 km (index 173)"));
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 12498.750 km (index 2)"));
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 44.750 km (index 0)"));
    ...
    public void testRunObdPgnSupports12691StoredFailureThirteenTwelveE() {
        ...
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 128.000 km (index 206)"));
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 14336.000 km (index 73)"));
    ...
    public void testRunObdPgnSupports12691ActiveFailureThirteenTwelveE() {
        ...
        GenericPacket response64256 = newGenericPacket(Packet.create(0xFB00,
                                                                     ...
                                                                     // @formatter:off
                                                                      0xF5, 0xDB, 0x00, 0x00, 0x00,
                                                                      0x06, 0x7D, 0x60, 0x00, 0x00,
                                                                      0xC0, 0xBC, 0x05, 0x00, 0x00,
                                                                      0xCE, 0x31, 0x02, 0x00, 0x00,
                                                                      0x49, 0x1D, 0x00, 0x00, 0x00,
                                                                      0x29, 0x00, 0x00, 0x00, 0x00,
                                                                      0xAD, 0x00, 0x00, 0x00, 0x00,
                                                                      0x02, 0x00, 0xF7, 0x00, 0x00,
                                                                      0x00, 0xF5, 0xD0, 0x00, 0x00
        ));
        // @formatter:on
        obdModule0.set(response64256, 2);
        when(communicationsModule.request(eq(64256),
        ...
        expected += "| Description                         |    Time, m  |   Dist, km  |    Time, m  |   Dist, km  |    Time, m  |   Dist, km  |" + NL;
        expected += "|-------------------------------------+-------------+-------------+-------------+-------------+-------------+-------------|" + NL;
        expected += "| SAE/ISO Reserved                    |       8,916 |           0 |       8,916 |          45 |     196,407 |           0 |" + NL;
        expected += "| Cylinder Deactivation               |      10,539 |           0 |      10,539 |      12,499 |  54,608,926 |           0 |" + NL;
        expected += "| Predictive Cruise Control           |       4,117 |           0 |       4,117 |           4 |      17,888 |           0 |" + NL;
        expected += "| Unknown 29                          |           0 |           0 |         N/A |         N/A |         N/A |         N/A |" + NL;
        expected += "| Unknown 49                          |           5 |           0 |           5 |      14,336 |  62,634,940 |           0 |" + NL;
        expected += "| Unknown 79                          |         N/A |         N/A |           0 |       8,638 |  37,741,090 |           0 |" + NL;
        expected += "| Unknown AD                          |           0 |           0 |           0 |      13,482 |  58,903,757 |           0 |" + NL;
        expected += "| Unknown C0                          |         245 |           0 |         245 |         256 |   1,118,506 |           0 |" + NL;
        expected += "| Unknown CE                          |          94 |           0 |          94 |         128 |     559,250 |           0 |" + NL;
        expected += "| Mfg Defined Active Technology 6     |          36 |           0 |          36 |          46 |   1,319,462 |           0 |" + NL;
        expected += "|-------------------------------------+-------------+-------------+-------------+-------------+-------------+-------------|" + NL;
        expected += NL;
        // @formatter:on
    ...
    public void testRunObdPgnSupports12691ThirteenTwelveH() {
        ...
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.h - Active Tech time received is > part 2 value + 600 seconds from Engine #1 (0) for SPN 12695, GHG Tracking Active 100 Hour Active Technology Time: 2420.000 s (index 245)"));
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 4.000 km (index 6)"));
    ...
    public void testRunObdPgnSupports12691WarningThirteenTwelveG() {
        ...
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.g - Active Tech time received is greater than part 2 value from Engine #1 (0) for SPN 12695, GHG Tracking Active 100 Hour Active Technology Time: 2190.000 s (index 245)"));
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(WARN),
                                        eq("6.11.13.12.i - Active Tech vehicle distance received is => 0.25km from Engine #1 (0) for SPN 12696, GHG Tracking Active 100 Hour Active Technology Vehicle Distance: 4.000 km (index 6)"));
    ...
    public void testRunObdPgnSupports12691WarningThirteenTwelveC() {
        ...
        verify(mockListener).addOutcome(eq(11),
                                        eq(13),
                                        eq(FAIL),
                                        eq("6.11.13.12.d - Active Technology value received is greater than 0xFAFF(h) and less than 0xFFFF(h) from Engine #1 (0) for SPN 12698, GHG Tracking Stored 100 Hour Active Technology Time: Not Available (index 245)"));
    ...
    public void testRunObdPgnSupports12691WarningThirteenTenA() {
        ...
        GenericPacket response64257 = newGenericPacket(Packet.create(0xFB01,
                                                                     0x00,
                                                                     // @formatter:off
                                                                      0xF5, 0xDB, 0x00, 00, 00, 0xB8, 0x04, 00, 00,
                                                                      0x06, 0x7D, 0x60, 00, 00, 0x10, 0x00, 00, 00
        ));
        // @formatter:on
        obdModule0.set(response64257, 2);
        ...
        expected += "| Description                         |    Time, m  |   Dist, km  |    Time, m  |   Dist, km  |    Time, m  |   Dist, km  |" + NL;
        expected += "|-------------------------------------+-------------+-------------+-------------+-------------+-------------+-------------|" + NL;
        expected += "| Predictive Cruise Control           |       4,117 |           0 |       4,117 |           4 |         N/A |         N/A |" + NL;
        expected += "| Mfg Defined Active Technology 6     |          36 |           0 |          36 |          46 |         N/A |         N/A |" + NL;
        expected += "|-------------------------------------+-------------+-------------+-------------+-------------+-------------+-------------|" + NL;
        expected += NL;
        // @formatter:on
