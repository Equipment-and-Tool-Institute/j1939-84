...
//                                                                      0x79, 0x00, 0x00, 0xF9, 0x86,
    ...
    public void testRunObdPgnSupports12675() throws BusException {
       ...
       GenericPacket response64276 = new GenericPacket(Packet.create(0xFB14, 0,
        ...
        expected += "|                           | NOx Mass, g  | NOx Mass, g  |  EOE, kWh    |   Fuel, l    | Hours, min   |  Dist, km    |" + NL;
        expected += "|---------------------------+--------------+--------------+--------------+--------------+--------------+--------------|" + NL;
        expected += "| Bin  1 (Total)            |       43,621 |      109,052 |       36,000 |       18,000 |        6,000 |        9,000 |" + NL;
        expected += "| Bin  2 (Idle)             |       43,621 |      109,052 |       21,160 |       10,580 |        3,527 |        5,290 |" + NL;
        expected += "| Bin  3 (<25%, <16kph)     |       43,621 |      109,052 |        3,778 |        1,889 |          630 |          944 |" + NL;
        expected += "| Bin  4 (<25%, 16-40kph)   |       43,621 |      109,052 |        3,752 |        1,876 |          625 |          938 |" + NL;
        expected += "| Bin  5 (<25%, 40-64kph)   |       43,621 |      109,052 |       18,893 |        9,446 |        3,149 |        4,723 |" + NL;
        expected += "| Bin  6 (<25%, >64kph)     |       43,621 |      109,052 |       44,372 |       22,186 |        7,395 |       11,093 |" + NL;
        expected += "| Bin  7 (25-50%, <16kph)   |       43,621 |      109,052 |            3 |            2 |            0 |            1 |" + NL;
        expected += "| Bin  8 (25-50%, 16-40kph) |       43,621 |      109,052 |       13,500 |        6,750 |        2,250 |        3,375 |" + NL;
        expected += "| Bin  9 (25-50%, 40-64kph) |       43,621 |      109,052 |          900 |          450 |          150 |          225 |" + NL;
        expected += "| Bin 10 (25-50%, >64kph)   |       43,621 |      109,052 |           16 |            8 |            3 |            4 |" + NL;
        expected += "| Bin 11 (>50%, <16kph)     |       43,621 |      109,052 |        9,000 |        4,500 |        1,500 |        2,250 |" + NL;
        expected += "| Bin 12 (>50%, 16-40kph)   |       43,621 |      109,052 |          156 |           78 |           26 |           39 |" + NL;
        expected += "| Bin 13 (>50%, 40-64kph)   |       43,621 |      109,052 |            7 |            4 |            1 |            2 |" + NL;
        expected += "| Bin 14 (>50%, >64kph)     |       43,621 |      109,052 |        1,800 |          900 |          300 |          450 |" + NL;
    ...
    @Test
    public void testRunObdPgnSupports12675FailureTwoB() throws BusException {
        int supportedSpn = 12675;
    ...
    @Test
    public void testRunObdPgnSupports12675FailureThirteenTwoA() throws BusException {
        int supportedSpn = 12675;
    ...
    @Test
    public void testRunObdPgnSupports12675FailureThirteenFourA() throws BusException {
        int supportedSpn = 12675;
    ...
    @Test
    public void testRunObdPgnSupports12675WarningThirteenFourB() throws BusException {
        int supportedSpn = 12675;
    ...
    @Test
    public void testRunObdPgnSupports12675FailureThirteenFourC() throws BusException {
        int supportedSpn = 12675;
        ...
        expected += "| Bin 12 (>50%, 16-40kph)   |       43,621 |      109,052 |          156 |           78 |           26 |           39 |" + NL;
        expected += "| Bin 13 (>50%, 40-64kph)   |       43,621 |      109,052 |            7 |            4 |            1 |            2 |" + NL;
        expected += "| Bin 14 (>50%, >64kph)     |       43,621 |      109,052 |        1,800 |          900 |Not Available |          450 |" + NL;
        expected += "| Bin 15 (NTE)              |       43,621 |      109,052 |            0 |            0 |            0 |            0 |" + NL;
        expected += "| Bin 16 (Regen)            |       43,621 |      109,052 |            0 |            0 |            0 |            0 |" + NL;
        expected += "| Bin 17 (MIL On)           |       43,621 |      109,052 |            0 |            0 |            0 |            0 |" + NL;
        expected += "|---------------------------+--------------+--------------+--------------+--------------+--------------+--------------|" + NL;
    ...
    @Test
    public void testRunObdPgnSupports12675FailureThirteenFourD() throws BusException {
        int supportedSpn = 12675;
        ...
        expected += "|                           | NOx Mass, g  | NOx Mass, g  |  EOE, kWh    |   Fuel, l    | Hours, min   |  Dist, km    |" + NL;
        expected += "|---------------------------+--------------+--------------+--------------+--------------+--------------+--------------|" + NL;
        expected += "| Bin  1 (Total)            |       43,621 |      109,052 |       36,000 |       17,920 |        6,000 |        9,000 |" + NL;
        expected += "| Bin  2 (Idle)             |       43,621 |      109,052 |       21,160 |       10,580 |        3,527 |        5,290 |" + NL;
        expected += "| Bin  3 (<25%, <16kph)     |       43,621 |      109,052 |        3,778 |        1,889 |          630 |          944 |" + NL;
        expected += "| Bin  4 (<25%, 16-40kph)   |       43,621 |      109,052 |        3,752 |        1,876 |          625 |          938 |" + NL;
        expected += "| Bin  5 (<25%, 40-64kph)   |       43,621 |      109,052 |       18,893 |        9,446 |        3,149 |        4,723 |" + NL;
    ...
    @Test
    public void testRunObdPgnSupports12675InfoThirteenFourE() throws BusException {
        int supportedSpn = 12675;
        ...
        expected += "|                           | NOx Mass, g  | NOx Mass, g  |  EOE, kWh    |   Fuel, l    | Hours, min   |  Dist, km    |" + NL;
        expected += "|---------------------------+--------------+--------------+--------------+--------------+--------------+--------------|" + NL;
        expected += "| Bin  1 (Total)            |       43,621 |      109,052 |       36,000 |       18,000 |            1 |        9,000 |" + NL;
        expected += "| Bin  2 (Idle)             |       43,621 |      109,052 |       21,160 |       10,580 |        3,527 |        5,290 |" + NL;
        expected += "| Bin  3 (<25%, <16kph)     |       43,621 |      109,052 |        3,778 |        1,889 |          630 |          944 |" + NL;
        expected += "| Bin  4 (<25%, 16-40kph)   |       43,621 |      109,052 |        3,752 |        1,876 |          625 |          938 |" + NL;
        expected += "| Bin  5 (<25%, 40-64kph)   |       43,621 |      109,052 |       18,893 |        9,446 |        3,149 |        4,723 |" + NL;
    ...
    @Test
    public void testRunObdPgnSupports12675InfoThirteenFourF() throws BusException {
        int supportedSpn = 12675;
