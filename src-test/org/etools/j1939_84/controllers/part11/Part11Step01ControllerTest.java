...
public class Part11Step01ControllerTest extends AbstractControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        instance = new Part11Step01Controller(executor,
                                              bannerModule,
    ...
    public void testIntoKeyState() {
        ...
        String expectedMessages = "Step 6.11.1.2.a - Waiting for engine start" + NL;
        expectedMessages += "Step 6.11.1.2.a - Waiting for engine start...";
    ...
    public void testUserQuits() {
        ...
        String userCancelledMessage = "Step 6.11.1.2.a - Waiting for engine start" + NL;
