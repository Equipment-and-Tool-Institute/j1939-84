...
public class Part11Step13ControllerSPN12730Test extends AbstractControllerTest {
    ...
    public void testRunObdPgnSupports12730() {
        ...
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += "| Engine Run Time, min    |       4,500 |       4,500 |  23,112,963 |" + NL;
        ...
        expected += "| Urban Speed Run Time,min|       1,688 |       1,688 |   1,966,080 |" + NL;
        expected += "| Idle Run Time, min      |         112 |         112 |           0 |" + NL;
        expected += "| Engine Idle Fuel, l     |           6 |           6 |           0 |" + NL;
        expected += "| PTO Run Time, min       |       1,125 |       1,125 |           0 |" + NL;
        expected += "| PTO Fuel Consumption, l |          59 |          59 |           0 |" + NL;
        expected += "| AES Shutdown Count      |           5 |           5 |           0 |" + NL;
        expected += "| Stop-Start Run Time, min|         225 |         225 |           0 |" + NL;
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += NL;
        // @formatter:on
    ...
    public void testRunObdPgnSupports12730WarningThirteenEightE() {
        ...
        expected += "|                         |   100 Hour  |   100 Hour  |   Lifetime  |" + NL;
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += "| Engine Run Time, min    |           1 |       4,500 |  23,112,963 |" + NL;
        expected += "| Vehicle Dist., km       |           0 |       7,053 |   1,229,474 |" + NL;
        expected += "| Vehicle Fuel, l         |       1,417 |       1,417 | 145,399,114 |" + NL;
        expected += "| Engine Fuel, l          |       1,407 |       1,407 |  44,236,800 |" + NL;
    ...
    public void testRunObdPgnSupports12730WarningThirteenEightC() {
        ...
        expected += "|                         |   100 Hour  |   100 Hour  |   Lifetime  |" + NL;
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += "| Engine Run Time, min    |         N/A |       4,500 |  23,112,963 |" + NL;
        ...
        expected += "| PKE Numerator           |     180,735 |     180,735 |  51,163,080 |" + NL;
        expected += "| Urban Speed Run Time,min|       1,688 |       1,688 |   1,966,080 |" + NL;
        expected += "| Idle Run Time, min      |         N/A |         112 |           0 |" + NL;
    ...
    public void testRunObdPgnSupports12730FailureThirteenSixD() {
        ...
        expected += "|                         |   100 Hour  |   100 Hour  |   Lifetime  |" + NL;
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += "| Engine Run Time, min    |       4,500 |       4,500 |           3 |" + NL;
        expected += "| Vehicle Dist., km       |           0 |       7,053 |   1,229,474 |" + NL;
        expected += "| Vehicle Fuel, l         |       1,417 |       1,417 | 145,399,114 |" + NL;
        expected += "| Engine Fuel, l          |       1,407 |       1,407 |  44,236,800 |" + NL;
        expected += "| Eng.Out.Energy, kW-hr   |           0 |      14,170 |   1,049,476 |" + NL;
    ...
    public void testRunObdPgnSupports12730FailureThirteenSixA() {
        ...
        expected += "|                         |   100 Hour  |   100 Hour  |   Lifetime  |" + NL;
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += "| Engine Run Time, min    |       4,500 |       4,500 |             |" + NL;
        ...
        expected += "| Urban Speed Run Time,min|       1,688 |       1,688 |             |" + NL;
        expected += "| Idle Run Time, min      |         112 |         112 |             |" + NL;
        expected += "| Engine Idle Fuel, l     |           6 |           6 |             |" + NL;
        expected += "| PTO Run Time, min       |       1,125 |       1,125 |             |" + NL;
        expected += "| PTO Fuel Consumption, l |          59 |          59 |             |" + NL;
        expected += "| AES Shutdown Count      |           5 |           5 |             |" + NL;
        expected += "| Stop-Start Run Time, min|         225 |         225 |             |" + NL;
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += NL;
        // @formatter:on
        assertEquals(expected, listener.getResults());
    ...
    public void testRunObdPgnSupports12730FailureThirteenEightF() {
        ...
        expected += "|                         |   100 Hour  |   100 Hour  |   Lifetime  |" + NL;
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += "| Engine Run Time, min    |          15 |       4,500 |  23,112,963 |" + NL;
