...
public class Part09Step11ControllerTest extends AbstractControllerTest {
    ...
    public void testHappyPathNoFailures() {
        ...
        obdModuleInformation.set(DM20MonitorPerformanceRatioPacket.create(0, 4, 2, ratio1, ratio2));
    ...
    public void testFailureForNoNACK() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.11.2.c - OBD module Engine #1 (0) did not provide a NACK for the DS query");
    }
