...
public class Part09Step13ControllerTest extends AbstractControllerTest {
    ...
    public void testHappyPathNoFailures() {
        ...
        obdModuleInformation2.set(DM28PermanentEmissionDTCPacket.create(1, OFF, OFF, OFF, OFF));
    ...
    public void testFailureForNoNACK() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.13.2.b - OBD module Engine #1 (0) did not provide a NACK for the DS query");
    }
