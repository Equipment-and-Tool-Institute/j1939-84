...
public class Part09Step18ControllerTest extends AbstractControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        instance = new Part09Step18Controller(executor,
                                              bannerModule,
    ...
    public void testFailureForNoNACK() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.18.2.c - OBD ECU Engine #1 (0) did not provide a NACK for the DS query");
    }
