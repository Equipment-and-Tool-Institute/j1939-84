...
import static net.solidDesign.j1939.packets.DM22IndividualClearPacket.create;
...
import static net.solidDesign.j1939.packets.DM22IndividualClearPacket.ControlByteSpecificIndicator.ACCESS_DENIED;
import static net.solidDesign.j1939.packets.DM22IndividualClearPacket.ControlByteSpecificIndicator.DTC_NOT_PA;
import static net.solidDesign.j1939.packets.DM22IndividualClearPacket.ControlByteSpecificIndicator.GENERAL_NACK;
import static net.solidDesign.j1939.packets.DM22IndividualClearPacket.ControlByteSpecificIndicator.NOT_SUPPORTED;
import static net.solidDesign.j1939.packets.DM22IndividualClearPacket.ControlByteSpecificIndicator.UNKNOWN_DTC;
...
public class Part09Step03ControllerTest extends AbstractControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        instance = new Part09Step03Controller(executor,
                                              bannerModule,
    ...
    public void testFailureForCLR_PA_ACK() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.2.a - Engine #2 (1) provided CLR_PA_ACK");
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        INFO,
                                        "6.9.3.3.a - Engine #2 (1) did not provide DM22 CLR_PA_NACK or CLR_ACT_NACK with acknowledgement code of 0");
    }
    ...
    public void testFailureForCLR_ACT_ACK() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.2.a - Engine #2 (1) provided CLR_ACT_ACK");
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        INFO,
                                        "6.9.3.3.a - Engine #2 (1) did not provide DM22 CLR_PA_NACK or CLR_ACT_NACK with acknowledgement code of 0");
    ...
    public void testFailureForAck() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.2.b - Engine #2 (1) provided J1939-21 ACK for PGN 49920");
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        INFO,
                                        "6.9.3.3.a - Engine #2 (1) did not provide DM22 CLR_PA_NACK or CLR_ACT_NACK with acknowledgement code of 0");
    ...
    public void testFailureForCLR_ACT_NACKWithNonZeroAck() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.2.c - Engine #2 (1) provided CLR_ACT_NACK with an acknowledgement code greater than 0");
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        INFO,
                                        "6.9.3.3.a - Engine #2 (1) did not provide DM22 CLR_PA_NACK or CLR_ACT_NACK with acknowledgement code of 0");
    ...
    public void testFailureForCLR_PA_NACKWithNonZeroAck() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.2.c - Engine #2 (1) provided CLR_PA_NACK with an acknowledgement code greater than 0");
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        INFO,
                                        "6.9.3.3.a - Engine #2 (1) did not provide DM22 CLR_PA_NACK or CLR_ACT_NACK with acknowledgement code of 0");
    ...
    public void testInfoForNACK() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        INFO,
                                        "6.9.3.3.b - Engine #2 (1) provided J1939-21 NACK for PGN 49920");
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        INFO,
                                        "6.9.3.3.a - Engine #2 (1) did not provide DM22 CLR_PA_NACK or CLR_ACT_NACK with acknowledgement code of 0");
    ...
    public void testFailureForCLR_PA_ACK3() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.8.a - Engine #1 (0) provided DM22 with CLR_PA_ACK");
    }
    ...
    public void testFailureForCLR_ACT_ACK3() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.8.a - Engine #1 (0) provided DM22 with CLR_ACT_ACK");
    }
    ...
    public void testFailureForACK() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.8.b - Engine #1 (0) provided J1939-21 ACK for PGN 49920");
    }
    ...
    public void testFailureForCLR_ACT_NACKWithNonZeroAck3() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.8.c - Engine #1 (0) provided CLR_ACT_NACK with an acknowledgement code greater than 0");
    }
    ...
    public void testFailureForCLR_PA_NACKWithNonZeroAck3() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.8.c - Engine #1 (0) provided CLR_PA_NACK with an acknowledgement code greater than 0");
    }
    ...
    public void testFailureForCLR_PA_ACK4() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.10.a - Engine #1 (0) provided DM22 with CLR_PA_ACK");
    }
    ...
    public void testFailureForCLR_ACT_ACK4() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.10.a - Engine #1 (0) provided DM22 with CLR_ACT_ACK");
    }
    ...
    public void testFailureForACK4() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.10.b - Engine #1 (0) provided J1939-21 ACK for PGN 49920");
    }
    ...
    public void testFailureForCLR_ACT_NACKWithNonZeroAck4() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.10.c - Engine #1 (0) provided CLR_ACT_NACK with an acknowledgement code greater than 0");
    }
    ...
    public void testFailureForCLR_PA_NACKWithNonZeroAck4() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.9.3.10.c - Engine #1 (0) provided CLR_PA_NACK with an acknowledgement code greater than 0");
    }
}
