...
public class Part02Step08ControllerTest extends AbstractControllerTest {
    ...
    public void testNoFailures() {
        ...
        expectedResults += "    Comprehensive component        enabled, not complete" + NL
                ...
                + "    EGR/VVT system                 enabled, not complete" + NL
                ...
                + "    NMHC converting catalyst       enabled, not complete" + NL
                + "    NOx catalyst/adsorber          enabled, not complete" + NL
    ...
    public void testFailureTimeDiffEightFiveA() {
        ...
        verify(mockListener).addOutcome(eq(2),
                                        eq(8),
                                        eq(FAIL),
                                        eq("6.2.8.2.a - DM5 message in 6.2.2.3 from Transmission #1 (3) monitor reported not supported and DM26 message reported not complete"));
        verify(mockListener).addOutcome(eq(2),
                                        eq(8),
                                        eq(FAIL),
                                        eq("6.2.8.2.c - DM5 message in 6.2.2.3 from Transmission #1 (3) monitor reported CCM supported and DM26 message reported disabled"));
        verify(mockListener).addOutcome(eq(2),
                                        eq(8),
                                        eq(FAIL),
                                        eq("6.2.8.5.a - Difference in data between DS and global responses from Transmission #1 (3)"));
    ...
    public void testInfoEightThreeB() {
        ...
        expectedResults += "    Comprehensive component        enabled, not complete" + NL
                ...
                + "    Catalyst                       enabled, not complete" + NL
                + "    NMHC converting catalyst       enabled, not complete" + NL
                + "    NOx catalyst/adsorber          enabled,     complete" + NL
                + "    Diesel Particulate Filter  not enabled,     complete" + NL
                + "    Boost pressure control sys     enabled, not complete" + NL
                + "    Cold start aid system      not enabled,     complete" + NL;
        expectedResults += "" + NL;
