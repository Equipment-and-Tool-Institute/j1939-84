...
public class Part03Step09ControllerTest extends AbstractControllerTest {
    ...
    public void testFailureForActiveDTC() {
        ...
        assertEquals("FAIL: 6.3.9.2.a - Engine #1 (0) reported an active DTC" + NL, listener.getResults());
    ...
    public void testFailureForMILNotOff() {
        ...
        assertEquals("FAIL: 6.3.9.2.a - Engine #1 (0) did not report MIL 'off'" + NL, listener.getResults());
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
    ...
    public void testFailureForNonOBDMILNotOff() {
        ...
        assertEquals("FAIL: 6.3.9.2.a - Non-OBD ECU Engine #2 (1) did not report MIL off or not supported" + NL,
                     listener.getResults());
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
    ...
    public void testFailureForGlobalDSDifference() {
        ...
        assertEquals("FAIL: 6.3.9.4.a - Difference compared to data received during global request from Engine #1 (0)" + NL,
                     listener.getResults());
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
    ...
    public void testFailureForNoNack() {
        ...
        assertEquals(
                "FAIL: 6.3.9.4.b - OBD module Engine #2 (1) did not provide a response to Global query and did not provide a NACK for the DS query" + NL,
                listener.getResults());
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.3.9.4.b - OBD module Engine #2 (1) did not provide a response to Global query and did not provide a NACK for the DS query");
    }
    ...
    public void testFailureForNoOBDResponse() {
        ...
        assertEquals("FAIL: 6.3.9.2.d - No OBD ECU provided a DM12" + NL, listener.getResults());
