...
public class Part03Step11ControllerTest extends AbstractControllerTest {
    ...
    public void testFailureForMILNotOff() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.3.11.2.b - Engine #1 (0) did not report MIL off");
    }
    ...
    public void testFailureForNonOBDMILNotOff() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.3.11.2.c - Non-OBD ECU Engine #2 (1) did not report MIL off or not supported");
    }
    ...
    public void testFailureForNoNack() {
        ...
        verify(mockListener).addOutcome(PART_NUMBER,
                                        STEP_NUMBER,
                                        FAIL,
                                        "6.3.11.4.b - OBD ECU Engine #2 (1) did not provide a response to Global query and did not provide a NACK for the DS query");
    }
