...
public class Part01Step20ControllerTest extends AbstractControllerTest {
    ...
    public void testEmptyPacketFailure() {
        ...
        when(dtcModule.requestDM28(any(), eq(0x01)))
        ...
        verify(dtcModule).requestDM28(any(), eq(0x01));
    ...
    public void testFailures() {
        ...
        when(dtcModule.requestDM28(any(), eq(0x03)))
        ...
        verify(dtcModule).requestDM28(any());
        verify(dtcModule).requestDM28(any(), eq(0x01));
        verify(dtcModule).requestDM28(any(), eq(0x03));
