...
public class Part01Step19ControllerTest extends AbstractControllerTest {
    ...
    /**
     * Test method for
     * {@link Part01Step19Controller#run()} with
    ...
    public void testEmptyPacketFailure() {
        ...
        when(dtcModule.requestDM23(any(), eq(0x01)))
        ...
        verify(dtcModule).requestDM23(any(), eq(0x01));
    ...
    /**
     * Test method for
     * {@link Part01Step19Controller##run()}
    ...
    public void testFailures() {
        ...
        when(dtcModule.requestDM23(any(), eq(0x03)))
        ...
        verify(dtcModule).requestDM23(any());
        verify(dtcModule).requestDM23(any(), eq(0x01));
        verify(dtcModule).requestDM23(any(), eq(0x03));
