...
public class TableA6ValidatorTest {
    ...
    public void testVerifyCompression() {
        ...
        MonitoredSystem system3 = new MonitoredSystem(CATALYST.getName(), status3, 0x00, CATALYST);
        ...
        MonitoredSystem system7 = new MonitoredSystem(EGR_VVT_SYSTEM.getName(), status7, 0x00, EGR_VVT_SYSTEM);
        ...
        MonitoredSystem system11 = new MonitoredSystem(FUEL_SYSTEM.getName(), status11, 0x00, FUEL_SYSTEM);

        MonitoredSystemStatus status12 = MonitoredSystemStatus.findStatus(false, false, false);
        MonitoredSystem system12 = new MonitoredSystem(HEATED_CATALYST.getName(), status12, 0x00, HEATED_CATALYST);

        MonitoredSystemStatus status13 = MonitoredSystemStatus.findStatus(false, true, true);
        MonitoredSystem system13 = new MonitoredSystem(MISFIRE.getName(), status13, 0x00, MISFIRE);
    ...
    public void testVerifyElectricFail() {
        ...
        StringBuilder expectedMessages = new StringBuilder(
                "FAIL: TableA6 A/C system refrigerant verification");
        expectedMessages.append(NL)
                .append("INFO: TableA6 Boost pressure control sys verification")
                .append(NL)
                .append("This test is only valid for compression or spark ignition")
                .append(NL)
                .append("INFO: TableA6 Catalyst verification")
                .append(NL)
                .append("This test is only valid for compression or spark ignition")
                .append(NL)
                .append("FAIL: TableA6 Cold start aid system verification")
                ...
                .append("FAIL: TableA6 Comprehensive component verification")
                .append(NL)
                .append("INFO: TableA6 Diesel Particulate Filter verification")
                .append(NL)
                .append("This test is only valid for compression or spark ignition")
                .append(NL)
                .append("FAIL: TableA6 EGR/VVT system verification")
                .append(NL)
                .append("INFO: TableA6 Evaporative system verification")
                .append(NL)
                .append("This test is only valid for compression or spark ignition")
                .append(NL)
                .append("FAIL: TableA6 Exhaust Gas Sensor verification")
                ...
                .append("FAIL: TableA6 Fuel System verification")
                .append(NL)
                .append("INFO: TableA6 Heated catalyst verification")
                .append(NL)
                .append("This test is only valid for compression or spark ignition")
                .append(NL)
                .append("FAIL: TableA6 Misfire verification")
                .append(NL)
                .append("INFO: TableA6 NMHC converting catalyst verification")
                .append(NL)
                .append("This test is only valid for compression or spark ignition")
                .append(NL)
                .append("FAIL: TableA6 NOx catalyst/adsorber verification")
