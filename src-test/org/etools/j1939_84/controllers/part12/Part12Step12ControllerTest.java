...
public class Part12Step12ControllerTest extends AbstractControllerTest {
    ...
    public void testHappyPathNoFailures() {
        ...
        obd0x00.setNonInitializedTests(getDmScaledTestResults());
    ...
    public void testObdNoResponseFailure() {
        ...
        verify(mockListener).addOutcome(eq(PART_NUMBER),
                                        eq(STEP_NUMBER),
                                        eq(FAIL),
                                        eq("6.12.12.5.a - NACK not received for DM7 PG from OBD ECU Engine #1 (0) for spn 27"));

        assertEquals("", listener.getMessages());
        assertEquals("", listener.getResults());
        ActionOutcome expectedActionOutcome = new ActionOutcome(FAIL,
                                                                "6.12.12.5.a - NACK not received for DM7 PG from OBD ECU Engine #1 (0) for spn 27");
