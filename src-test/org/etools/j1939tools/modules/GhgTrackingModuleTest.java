...
public class GhgTrackingModuleTest {
    ...
    private GhgTrackingModule instance;

    @Before
    public void setUp() throws Exception {
        instance = new GhgTrackingModule(new TestDateTimeModule());
    }
    ...
    public void testFormat() {
        ...
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += "| Engine Run Time, min    |       4,500 |       2,077 |  23,112,963 |" + NL;
        ...
        expected += "| Urban Speed Run Time,min|       1,688 |           5 |   1,966,080 |" + NL;
        expected += "| Idle Run Time, min      |         112 |       5,041 |           0 |" + NL;
        expected += "| Engine Idle Fuel, l     |           6 |          37 |           0 |" + NL;
        expected += "| PTO Run Time, min       |       1,125 |       9,144 |           0 |" + NL;
        expected += "| PTO Fuel Consumption, l |          59 |       1,532 |           0 |" + NL;
        expected += "| AES Shutdown Count      |           5 |      59,293 |           0 |" + NL;
        expected += "| Stop-Start Run Time, min|         225 |           2 |           0 |" + NL;
        expected += "|-------------------------+-------------+-------------+-------------|" + NL;
        expected += "" + NL;
