...
public class RP1210Bus implements Bus {
	...
	public RP1210Bus(RP1210Library rp1210Library, ScheduledExecutorService exec, MultiQueue<Packet> queue,
		...
		verify(clientId);
		try {
			sendCommand(CMD_PROTECT_J1939_ADDRESS, new byte[] { (byte) address, 0, 0, (byte) 0xE0, (byte) 0xFF, 0,
	...
	public void send(Packet packet) throws BusException {
		try {
			...
			Future<Short> rtn = exec.submit(() -> rp1210Library.RP1210_SendMessage(clientId, data, (short) data.length,
