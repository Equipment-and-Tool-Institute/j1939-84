...
/**
 * 6.5.1 Verify Engine Running
 */
public class Part05Step01Controller extends StepController {
    private static final int PART_NUMBER = 5;
    private static final int STEP_NUMBER = 1;
    private static final int TOTAL_STEPS = 0;

    Part05Step01Controller() {
    ...
    protected void run() throws Throwable {
        ...
        // then press enter.
        ensureKeyStateIs(KEY_ON_ENGINE_RUNNING, "6.5.1.2.a");
    }
