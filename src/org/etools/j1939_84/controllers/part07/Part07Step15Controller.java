...
public class Part07Step15Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        // 6.7.15.1.a.i. If TID 246 method not supported, use DS DM7 with TID 247 + each DM24 SPNSP+ FMI 31. b. Create list of any ECU address+SPN+FMI combination with non-initialized test results.
        // 6.7.15.2.a. Fail if any difference in the ECU address+SPN+FMI combinations that report test results compared to list created in part 1.
