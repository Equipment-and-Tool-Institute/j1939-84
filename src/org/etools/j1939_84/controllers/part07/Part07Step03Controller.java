...
public class Part07Step03Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        // 6.7.3.2.b (if supported) Fail if any OBD ECU reports a fewer previously active DTCs than in DM23 response earlier in this part.
        // 6.7.3.2.c (if supported) Fail if any OBD ECU fails to provide its DTC from its DM12 response in part 6 as a previously active DTC in its DM2 response.
        // 6.7.3.2.d (if supported) Fail if any OBD ECU does not report MIL off. See Section A.8 for allowed values. Fail if any non-OBD ECU does not report MIL off or not supported.
