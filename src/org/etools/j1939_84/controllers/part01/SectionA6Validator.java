...
public class SectionA6Validator {
    ...
    public boolean verify(ResultsListener listener,
        ...
        List<Integer> packets = response.getPackets()
                                        .stream()
        ...
        List<CompositeSystem> supportedSystems = response.getPackets()
                                                         .stream()
        ...
        List<DM5DiagnosticReadinessPacket> nonObdPackets = response.getPackets()
                                                                   .stream()
