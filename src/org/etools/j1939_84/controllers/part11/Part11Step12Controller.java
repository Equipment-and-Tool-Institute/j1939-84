...
public class Part11Step12Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        //   expected value (calculated using the original DM26 response in this part from 6.11.3 plus the accumulated time since then);.
        //   [i.e., Fail if ABS[(Time SCCB - Time SCCA) (minutes) - Truncate((Time Since Engine StartB - Time Since Engine StartA) / 60 (seconds/minute)) > 1 minute].
