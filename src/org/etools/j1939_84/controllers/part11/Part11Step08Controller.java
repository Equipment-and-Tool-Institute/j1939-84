...
public class Part11Step08Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        // 6.11.8.2.b. Fail if any response indicates that the general denominator (SPN 3049) has not incremented by one
        // from value earlier in part 9.
        // 6.11.8.2.c. Fail if NACK received from OBD ECUs that previously provided a DM20 message.
        // 6.11.8.3.a. Warn if any response indicates denominator for SCR, EGR, NOx sensor, boost, and fuel system have
        ...
        // 6.11.8.3.c.i. Warn if any value (numerator, denominator, or ignition cycle counter) is less than their
        // corresponding value in part 1.
        // 6.11.8.3.d. If more than one ECU reports DM20 data, warn if general denominators or ignition cycle counts do
        // not match from all ECUs.
    }
