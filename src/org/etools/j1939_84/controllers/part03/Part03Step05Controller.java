                ...
                .forEach(moduleAddress -> {
                    ...
                    if (!packets.isEmpty()) {
                        ...
                        boolean milNotOff = packets
                                ...
                                .anyMatch(milStatus -> milStatus != OFF && milStatus != ALTERNATE_OFF);
                        if (milNotOff) {
                            addFailure("6.3.5.2.a - " + moduleName + " did not report MIL 'off' in all returned DTCs");
                        }
                    } else {
                        ...
                        boolean nackReceived = response.getAcks()
                                ...
                                .anyMatch(r -> r == NACK);
                        if (!nackReceived) {
                            addFailure("6.3.5.2.b - " + moduleName + " did not provide a DM31 and did not NACK the request");
                        }
                    }
                });
