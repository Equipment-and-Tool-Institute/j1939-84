...
public class Part03Step10Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        globalPackets.stream()
                ...
                .map(ParsedPacket::getModuleName)
                .forEach(moduleName -> addFailure("6.3.10.2.a - Non-OBD ECU " + moduleName + " did not report MIL off or not supported"));
        ...
        checkForNACKs(globalPackets, filterAcks(dsResults), obdModuleAddresses, "6.3.10.4.b");
    }
