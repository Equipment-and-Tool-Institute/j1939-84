...
public class Part02Step12Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        List<DM29DtcCounts> globalPackets = dtcModule.requestDM29(getListener()).getPackets();
        ...
        globalPackets.stream()
                ...
                .forEach(moduleName -> addFailure("6.2.12.2.a - " + moduleName + " did not report pending/all pending/MIL on/previous MIL on/permanent = 0/0/0/0/0"));
        ...
        globalPackets.stream()
                ...
                .map(Lookup::getAddressName)
                .forEach(moduleName -> addFailure("6.2.12.2.b - " + moduleName + " did not report pending/all pending/MIL on/previous MIL on/permanent = 0/0xFF/0/0/0"));
