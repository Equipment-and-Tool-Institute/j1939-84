...
public class Part04Step09Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        globalPackets.stream()
                ...
                .map(ParsedPacket::getModuleName)
                .forEach(moduleName -> addFailure("6.4.9.2.b - " + moduleName + " reported a different MIL status that it did for DM12 response earlier in this part"));
        ...
        var dsResults = obdModuleAddresses
                .stream().map(address -> getDiagnosticMessageModule().requestDM27(getListener(), address))
        ...
        checkForNACKs(globalPackets, filterAcks(dsResults), obdModuleAddresses, "6.4.9.4.b");
    }
