...
public class Part04Step10Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        packets.stream()
                ...
                .forEach(moduleName -> addFailure("6.4.10.2.b - " + moduleName + " did not report DTC in freeze frame data which included the DTC reported in DM12 earlier in this part"));
