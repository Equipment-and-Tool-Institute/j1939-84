...
public class Part08Step16Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        // 6.8.16.1.c With the key in the off position remove the implanted Fault B, according to the manufacturer’s instructions for restoring the system to a fault- free operating condition.
