...
public class Part08Step12Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        // 6.8.12.2.a. Fail if the ECU provides CLR_PA_ACK or CLR_ACT_ACK (as described in SAE J1939-73 paragraph 5.7.22).
        // 6.8.12.2.b. Fail if the ECU provides J1939-21 ACK for PGN 49920.
        // 6.8.12.2.c. Fail if the ECU provides CLR_ACT_NACK or CLR_PA_NACK with an acknowledgement code greater than 0.46
        // 6.8.12.3.a. Info: if DM22 (PGN 49920) CA_PA_NACK or CA_ACT_NACK is not received with an acknowledgement code of 0.47
        // 6.8.12.3.b. Info: if J1939-21 NACK for PGN 49920 is received.
        // 6.8.12.4.a. DS DM22 to OBD ECU with a DM12 MIL on DTC stored using the DM12 MIL On DTC SPN and FMI and control byte = 1, Request to Clear/Reset Previously Active DTC.
        ...
        // 6.8.12.6.a. Warn if DM22 (PGN 49920) CA_PA_NACK or CA_ACT_NACK is not received with an acknowledgement code of 0.
        // 6.8.12.6.b. Warn if J1939-21 NACK for PGN 49920 is received.
        // 6.8.12.7.a. Global DM22 using DM12 MIL On DTC SPN and FMI with control byte = 1, Request to Clear/Reset Previously Active DTC.
        ...
        // 6.8.12.9.a. Global DM22 using DM12 MIL On DTC SPN and FMI with control byte = 17, Request to Clear/Reset Active DTC.
        ...
        // 6.8.12.10.c. Fail if any ECU provides CLR_ACT_NACK or CLR_PA_NACK with an acknowledgement code greater than 0.
