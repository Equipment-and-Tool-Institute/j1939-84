...
public class Part12Step04Controller extends StepController {
    ...
    protected void run() throws Throwable {
        // 6.12.4.1.a. DS DM28 [send Request (PGN 59904) for PGN 64896 (SPNs 1213-1215, 1706, and 3038] to each OBD ECU.
        ...
        packets.stream()
               ...
               .forEach(moduleName -> {
                   addFailure("6.12.4.2.a - " + moduleName + " reported a permanent DTC");
               });

        // 6.12.4.2.b. Fail if NACK not received from OBD ECUs that did not provide a DM28 message.
        checkForNACKsDS(packets, filterAcks(dsResults), "6.12.4.2.b");
    }
