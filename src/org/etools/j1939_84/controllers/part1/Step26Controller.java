...
public class Step26Controller extends StepController {
    ...
    protected void run() throws Throwable {
        ...
        // for
        // We listen for missing SPNs from all modules, rather than waiting for
        // each module
        ...
        getListener().onResult(
                "SKIPPED: d. Fail/warn if any broadcast data is not valid for KOEO conditions as per Table A-1, Minimum Data Stream Support.");
